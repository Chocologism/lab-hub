...
<template>
  <main class="share-page"><section class="share-card"><div class="share-top"><div class="share-brand-wrap"><img src="/assets/LO_logo.svg" alt="LabOrbit Logo" class="share-brand-logo" /><span>{{ siteConfig.labShortName || 'LabOrbit' }}</span></div><p>文献快速分享</p></div><h1>把这篇论文加入讨论</h1><p class="subtitle">粘贴论文链接，核对元数据，再选择公开或定向推荐。</p>
